<script lang="ts">
    ...
    const snsList: SNS[] = [
        {
            name: "GitHub",
            url: "https://github.com/bogbu",
            icon: "github",
        },
        {
            name: 'Twitter',
            url: "https://x.com/bogbogbu",
            icon: 'twitter',
        },
    ]
</script>
...
<section class="flex flex-col gap-1">
    {#each snsList as sns}
        <a href={sns.url} target="_blank" rel="noopener noreferrer" class="flex items-center gap-2">
            {#if sns.icon === "github"}
